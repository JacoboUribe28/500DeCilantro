        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:block md:w-1/2 bg-gradient-to-br from-gray-900 to-gray-950 p-12 text-white">
            <div className="flex flex-col h-full">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-6">¡Únete a VenecFood!</h1>
                <p className="text-lg text-gray-300">
                  Crea tu cuenta y disfruta de los mejores restaurantes y las mejores ofertas en comida a domicilio.
                </p>
            ...
            <div className="max-w-md mx-auto">
              ...
              <form className="space-y-6">
                ...
                <p className="text-center text-sm text-gray-400">
                  ...
                  <Link to="/auth/signin" className="text-green-500 hover:text-green-400 font-medium">
                    Inicia sesión
                  </Link>
                </p>
              </form>
