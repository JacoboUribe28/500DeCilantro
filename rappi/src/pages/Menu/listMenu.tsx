...
const ListMenu = () => {
    ...
    // Obtiene los datos de los menús
    ...
    const handleDelete = async (id: number) => {
        console.log(`Intentando eliminar menú con ID: ${id}`);
        Swal.fire({
            title: "Eliminación",
                            ...
                            <table className="w-full text-sm text-left rtl:text-right text-gray-500">
                                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" className="px-6 py-3">ID Restaurante</th>
                                ...
                                <tbody>
                                    {data.map((item) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">{item.availbality ? "Sí" : "No"}</td>
                                            <td className="px-6 py-4">{item.restaurant_id}</td>
